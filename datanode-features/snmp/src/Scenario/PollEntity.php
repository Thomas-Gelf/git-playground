...
use IcingaFeature\Snmp\DataMangler\MangleToUtf8;
...
use IcingaFeature\Snmp\DataStructure\EntityPhysicalClass;
...
class PollEntity
{
    public function __construct(
        ...
        public readonly ?string $description, // entPhysicalDescr

        #[Oid('1.3.6.1.2.1.47.1.1.1.1.4')]
        #[DbColumn('parent_index')]
        public readonly ?string $parentIndex, // entPhysicalContainedIn

        #[Oid('1.3.6.1.2.1.47.1.1.1.1.5')]
        #[DbColumn('class')]
        public readonly ?EntityPhysicalClass $class, // entPhysicalClass

        #[Oid('1.3.6.1.2.1.47.1.1.1.1.6')]
        #[DbColumn('relative_position')]
        public readonly ?string $relativePosition, // entPhysicalParentRelPos

        #[Oid('1.3.6.1.2.1.47.1.1.1.1.7')]
        #[DbColumn('name')]
        public readonly ?string $name, // entPhysicalName

        #[Oid('1.3.6.1.2.1.47.1.1.1.1.16')]
        #[DbColumn('field_replaceable_unit')]
        public readonly ?TruthValue $fieldReplaceableUnit, // entPhysicalIsFRU
        ...
        public readonly ?string $revisionHardware, // entPhysicalHardwareRev

        #[Oid('1.3.6.1.2.1.47.1.1.1.1.9')]
        #[DbColumn('revision_firmware')]
        public readonly ?string $revisionFirmware, // entPhysicalFirmwareRev

        #[Oid('1.3.6.1.2.1.47.1.1.1.1.10')]
        #[DbColumn('revision_software')]
        public readonly ?string $revisionSoftware, // entPhysicalSoftwareRev
        ...
        public readonly ?string $serialNumber, // entPhysicalSerialNum

        #[Oid('1.3.6.1.2.1.47.1.1.1.1.12')]
        #[DbColumn('manufacturer_name')]
        #[MangleToUtf8]
        public readonly ?string $manufacturerName, // entPhysicalMfgName

        // Cisco: Orderable product identifier—Product Identifier (PID) is the alphanumeric identifier used by customers
        // to order Cisco products. Two examples include NM-1FE-TX and CISCO3745. PID is limited to 18 characters and
        // must be stored in the entPhysicalModelName object.
        #[Oid('1.3.6.1.2.1.47.1.1.1.1.13')]
        #[DbColumn('model_name')]
        public readonly ?string $modelName, // entPhysicalModelName

        #[Oid('1.3.6.1.2.1.47.1.1.1.1.14')]
        #[DbColumn('alias')]
        public readonly ?string $alias, // entPhysicalAlias

        #[Oid('1.3.6.1.2.1.47.1.1.1.1.15')]
        #[DbColumn('asset_id')]
        public readonly ?string $assetId, // entPhysicalAssetID
