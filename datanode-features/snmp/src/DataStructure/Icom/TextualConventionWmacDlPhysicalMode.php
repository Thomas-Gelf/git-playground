...
// The allowed value of downlink physical modes
// Hint: Quadrature amplitude modulation (QAM)
enum TextualConventionWmacDlPhysicalMode: int implements EnumInterface
{
