...
namespace IcingaFeature\Snmp\DataStructure\Icom;

use IcingaFeature\Snmp\DataStructure\EnumInterface;
use IcingaFeature\Snmp\DataStructure\Oid;

#[Oid('1.3.6.1.4.1.1807.112.1.4.1.6')]
enum IcomWmacBsTsStatusUiuc: int implements EnumInterface
{
    ...
    case MODE_128QAM       = 7;
    case MODE_256QAM       = 8;
    case MODE_512QAM       = 9; // Not available for upload (this class)

    case MODE_1024QAM_LOW  = 10; // Not available for upload (this class)
    case MODE_1024QAM_HIGH = 11; // Not available for upload (this class)
