...
use IcingaFeature\Snmp\SnmpScenario\Event\DbUpdateEvent;
use IcingaFeature\Snmp\SnmpScenario\Event\EventDispatcher;
use IcingaFeature\Snmp\SnmpScenario\Event\PerfDataEvent;
