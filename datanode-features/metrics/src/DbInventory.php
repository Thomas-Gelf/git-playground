...
class DbInventory
{
    ...
    public function registerMetricsStore(MetricStore $store): bool
    {
        return $this->storeWithUuid($store->getUuid(), 'metric_store', [
            'label'         => $store->getName(),
            'datanode_uuid' => $store->getNodeUuid()->getBytes(),
            'basedir'       => $store->getBaseDir(),
            'rrdtool_path'  => '/usr/bin', // TODO: This is not correct
            'redis_path'    => '/usr/bin', // TODO: This is not correct
    ...
    {
        $table = 'ci';
        $checksum = $ci->calculateChecksum(); // TODO!
    ...
    public function registerFile(
        UuidInterface $uuid,
        \IcingaDataNode\Monitoring\Ci            $ci,
