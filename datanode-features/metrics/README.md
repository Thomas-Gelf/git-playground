...
Datanode Feature Integration (tech)
-----------------------------------

store->subscribe('snmp/perfdata')


| Format            | Rendering Time |     File size | Compressed (gzip) |
|-------------------|---------------:|--------------:|------------------:|
| SVG with gradient |        10.87ms |  *422.30 KiB* |         33.10 KiB |
| SVG w/o gradient  |     **2.73ms** |     91.49 KiB |     **10.70 KiB** |
| PNG with gradient |      *43.59ms* |     94.23 KiB |       *91.63 KiB* |
| PNG w/o gradient  |        18.68ms | **24.28 KiB** |         20.39 KiB |
